...
const Post = () => {
  ...
  <div className="container px-5 py-14 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-full md:px-0 px-20 object-cover object-top rounded" src="https://assets.myntassets.com/h_1440,q_90,w_1080/v1/assets/images/15144304/2021/8/13/defcdc57-3c80-45e9-92c2-db9f8095b21d1628866321029Sweatshirts1.jpg"/>
